"""
Data Manager - Persistent storage for user data, progress, and authentication
Now uses Supabase for cloud persistence (works on Streamlit Cloud!)
Falls back to JSON if Supabase not configured (local development)
"""
...
class DataManager:
    ...
    def award_badge(username: str, badge_name: str, badge_description: str):
        ...
        if badge not in progress[username]["badges"]:
